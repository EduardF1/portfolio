# Reads EXIF (DateTimeOriginal, GPS, Camera model) from a folder of JPEGs and emits NDJSON to stdout.
# Usage: pwsh -NoProfile -File scripts/extract-exif.ps1 -Folder 'D:\Portfolio'
param(

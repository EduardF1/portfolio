...
const CHAPTERS: Chapter[] = [
  {
    ...
    body: "I started in Denmark with an AP Degree in Marketing & Management at IBA Kolding. I came in from a Romanian high school in natural sciences (mathematics and informatics), and the move was as much about learning to operate in Danish-language work culture as it was about the field. The diploma gave me a working vocabulary for business: briefs, stakeholders, market context, the kind of vocabulary I still use when I sit on the engineering side of a delivery and need to read what the other half of the room actually wants.",
  ...
  },
  {
    ...
    body: "Just shy of three years at Greenbyte: first as a student software engineer alongside the MSc, then full-time after graduation. .NET Core with EF Core on the backend, React on the web, and a Flutter / Dart mobile companion app where I was architect and lead developer. It is also where the DevOps research for my master's thesis was grounded: an honest empirical study of what made adoption stick in a small-to-mid-sized engineering team, sitting inside the team it was studying.",

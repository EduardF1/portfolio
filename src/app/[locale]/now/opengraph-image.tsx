...
export const alt = "Now — Eduard Fischer-Szava";
    ...
    (
      <div
        style={{
          ...
          backgroundImage:
            "radial-gradient(circle at 50% 50%, rgba(224,139,110,0.4) 0%, rgba(21,17,13,0) 60%), linear-gradient(180deg, #15110D 0%, #1F1B16 100%)",
          color: "#F2EEE3",
      ...
      >
        ...
        >
          ...
          <span style={{ color: "#E08B6E" }}>/now</span>
        </div>

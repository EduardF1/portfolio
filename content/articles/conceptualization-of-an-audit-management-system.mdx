...
- A hybrid pattern — a thin LEGO-built core (auth, user management, dashboards) plus a vendor module on top, with a data lake as the single source of truth for partner and factory data — was put forward as a credible long-term shape.
...
My specific contribution to this co-authored thesis is to be added by Eduard.
